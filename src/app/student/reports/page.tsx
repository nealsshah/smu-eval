...
const POWERBI_URL =
  "https://app.powerbi.com/view?r=eyJrIjoiNjI1MWUyZGYtZmMxMS00NzllLTk1YzEtNGE4YzRmOWYzZjc5IiwidCI6IjYwOTU2ODg0LTEwYWQtNDBmYS04NjNkLTRmMzJjMWUzYTM3YSIsImMiOjF9";
...
export default async function StudentReports() {
  ...
  return (
    <div>
      <PageHeader title="Reports" subtitle="View your performance dashboard" />

      <div className="rounded-lg border border-smu-border overflow-hidden bg-white">
        <iframe
          title="SMU Student Dashboard"
          src={POWERBI_URL}
          className="w-full"
